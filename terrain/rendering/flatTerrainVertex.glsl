...
flat out vec3 pass_colors;//The "flat" qualifier stops the colors from being interpolated over the triangles.
...
vec3 calculateLighting(){
	...
	return (lightcolors * lightBias.x) + (brightness * lightcolors * lightBias.y);
}
...
void main(void){
	...
	pass_colors = in_colors.rgb * lighting;
